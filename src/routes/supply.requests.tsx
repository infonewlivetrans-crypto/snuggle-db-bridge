                    ...
                    <li key={h.id} className="relative">
                      ...
                      <div className="flex flex-wrap items-center gap-2">
                        ...
                        <span className="ml-auto text-xs text-muted-foreground">
                          <span suppressHydrationWarning>{new Date(h.changed_at).toLocaleString("ru-RU")}</span>
                        </span>
                      </div>
                      {h.changed_by && (
                          ...
                          {h.in_transit_snapshot ? (
                            <div className="mt-1 space-y-0.5">
                              ...
                              {h.in_transit_snapshot.created_at && (
                                <div>
                                  Создана:{" "}
                                  <span suppressHydrationWarning>{new Date(h.in_transit_snapshot.created_at).toLocaleString("ru-RU")}</span>
                                </div>
                              )}
                            </div>
                          ) : (
