              ...
              {problems.map((p) => (
                ...
                >
                  ...
                  <div className="mt-1 flex flex-wrap gap-x-3 gap-y-0.5 text-[11px] text-muted-foreground">
                    ...
                    <span><span suppressHydrationWarning>{new Date(p.created_at).toLocaleString("ru-RU")}</span></span>
                    {p.urgency === "urgent" && (
        ...
        {problem && (
          <div className="space-y-3 text-sm">
            ...
            <div className="flex flex-wrap gap-x-4 gap-y-1 text-xs text-muted-foreground">
              ...
              <span><span suppressHydrationWarning>{new Date(problem.created_at).toLocaleString("ru-RU")}</span></span>
            ...
            {problem.resolved_by && problem.resolved_at && (
              <div className="text-[11px] text-muted-foreground">
                ...
                <span suppressHydrationWarning>{new Date(problem.resolved_at).toLocaleString("ru-RU")}</span>
              </div>
            )}
          </div>
        )}
