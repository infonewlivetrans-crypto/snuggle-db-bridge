          ...
          >
            ...
            {lowStockSummary.lastAt && (
              <span className="shrink-0 text-orange-700">
                <span suppressHydrationWarning>{new Date(lowStockSummary.lastAt).toLocaleString("ru-RU", {
                  day: "2-digit",
                  month: "2-digit",
                  hour: "2-digit",
                  minute: "2-digit",
                    ...
                    <div className="min-w-0 flex-1">
                      <div className="flex items-start justify-between gap-2">
                        ...
                        <span className="shrink-0 text-[11px] text-muted-foreground">
                          <span suppressHydrationWarning>{new Date(n.created_at).toLocaleTimeString("ru-RU", {
                            hour: "2-digit",
                            minute: "2-digit",
                          })}</span>
                        </span>
