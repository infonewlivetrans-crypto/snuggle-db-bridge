export type DeliveryRouteStatus = "draft" | "formed" | "issued" | "in_progress" | "completed";
...
export const DELIVERY_ROUTE_STATUS_STYLES: Record<DeliveryRouteStatus, string> = {
  ...
  issued: "bg-amber-100 text-amber-900 border-amber-200 dark:bg-amber-900/40 dark:text-amber-200",
