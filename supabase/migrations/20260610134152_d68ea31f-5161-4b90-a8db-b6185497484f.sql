...
-- Backfill missing links for already-registered carriers
INSERT INTO public.dispatcher_carrier_users (dispatcher_carrier_ext_id, user_id, status, created_by)
SELECT ext.id, p.user_id, 'active', p.user_id
FROM public.profiles p
JOIN public.dispatcher_carrier_ext ext ON ext.carrier_id = p.carrier_id
