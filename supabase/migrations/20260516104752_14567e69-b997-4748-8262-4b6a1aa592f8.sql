-- Table
CREATE TABLE public.client_order_messages (
...
BEGIN
  ...
  PERFORM 1 FROM public.orders o
   WHERE o.id = _order_id AND o.client_id = v_client_id;
  IF NOT FOUND THEN
    RAISE EXCEPTION 'forbidden' USING ERRCODE = '42501';
  END IF;
...
-- =========================================================================
-- Staff RPCs (manager / logist / admin)
-- =========================================================================
...
-- =========================================================================
-- Driver RPCs (admin OR driver assigned to the route containing this order)
-- =========================================================================
