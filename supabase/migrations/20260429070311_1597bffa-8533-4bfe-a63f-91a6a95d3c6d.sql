  ...
  IF TG_OP = 'UPDATE'
    ...
    SELECT
      COALESCE(jsonb_agg(jsonb_build_object(
        ...
        'return_warehouse_id', rp.dp_return_warehouse_id,
        'return_warehouse_name', wh.name,
        'return_comment', rp.dp_return_comment,
        'expected_return_at', rp.dp_expected_return_at,
    ...
    LEFT JOIN public.warehouses wh ON wh.id = rp.dp_return_warehouse_id
